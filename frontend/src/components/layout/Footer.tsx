      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="font-mono text-xs text-text-muted bg-forge-800 rounded px-3 py-2 inline-flex items-center gap-2 w-full min-w-0 max-w-full">
              <span className="truncate min-w-0 flex-1">{FNDRY_CA.slice(0, 8)}...{FNDRY_CA.slice(-4)}</span>
              <button
                onClick={copyCA}
