  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      >
        ...
        <div className="p-5 font-mono text-sm leading-relaxed">
          <div className="overflow-hidden">
            ...
            <span className="text-text-secondary overflow-hidden whitespace-nowrap inline-block animate-typewriter max-w-[220px] sm:max-w-none">
      ...
      <motion.h1
        ...
        className="font-display text-2xl sm:text-3xl md:text-5xl font-bold text-text-primary tracking-wider text-center mt-10 leading-tight"
      >
      ...
      <motion.div
        ...
        className="flex items-center justify-center gap-4 sm:gap-6 mt-8 font-mono text-xs sm:text-sm text-text-muted flex-wrap"
      >
        <span>
