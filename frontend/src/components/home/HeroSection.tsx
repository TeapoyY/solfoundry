...
/** GitHub SVG icon for the sign-in button. */
const GitHubIcon = () => (
...
/**
 * Animated ember particles rising from the hero background.
 * @param count - Number of particles to render (default: 5)
 */
 ...
 * @param suffix  - Optional string suffix (e.g. "+" or "K")
 */
...
/**
 * Hero section for the SolFoundry homepage.
 * Features an animated terminal card, headline, CTAs, and live bounty stats.
 */
